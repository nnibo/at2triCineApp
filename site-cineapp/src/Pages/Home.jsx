...
function Home() {
    return (
        ...
        <div className='mt-20'>
            <div className='flex flex-col lg:flex-row items-center space-y-5 lg:space-y-0 lg:space-x-[50px] m-[20px] lg:m-[100px]'>
            ...
            <div className='flex flex-col'>
                ...
                <div>
                    <p className="text mb-3 text-gray-300 mt-5 ">Lorem Ipsum is simply dummy text of the printing and typesetting industry.
